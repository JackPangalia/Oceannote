  ...
  return (
    <div ref={contextMenuRef}>
      ...
      <div
        ...
        } bg-lightMode dark:bg-darkMode shadow-md dark:border-zinc-500 border-zinc-800 border-[1px] absolute p-2 grid grid-cols-2 gap-1 rounded-md`}
      >
        <button
      ...
      <div
        ...
        } absolute dark:bg-darkMode dark:border-zinc-500 bg-lightMode shadow-md border-zinc-800 border-[1px] p-2 flex-col rounded-md`}
      >
        <label className="text-sm mb-2">delete notes</label>
        <button
      ...
      <div
        ...
        } bg-lightMode dark:bg-darkMode absolute border-[1px] border-zinc-800 shadow-md rounded-md p-2 flex flex-col gap-2 text-sm min-w-50 dark:border-zinc-500`}
      ...
      >
        ...
        {folders.map((folder, index) => (
          <button
            ...
            className="dark:bg-darkMode bg-lightMode px-2 rounded border-[1px] border-zinc-800 dark:border-zinc-500 text-start dark:hover:bg-zinc-800 hover:bg-zinc-200 transition-all duration-150"
            key={index}
          >
            {folder.name}
          </button>
      ...
      <div
        ...
        className="absolute z-50 text-black dark:text-white bg-lightMode dark:bg-darkMode dark:border-zinc-500 shadow-md border-zinc-800 border-[1px] px-3 py-2 flex items-center gap-2 rounded-md "
      >
        <button
          className="text-lg"
          onClick={() => {
